        ...
        <div>
            ...
            <div style={{ margin: "50px 0 0 0" }} >
                ...
                <form onSubmit={handleSubmit} noValidate>
                    ...
                    <button type="submit" style={{ float: "right", marginRight: "22%", fontWeight: "640", background: "linear-gradient(to left, Grey , DarkGrey)", border: "none", borderRadius: "50px", padding: "10px 20px", fontSize: "12px" }}><img style={{ marginBottom: "3px", width: "15px" }} src="baseline_send_black_24dp.png" /> RESERVE TABLE</button>
